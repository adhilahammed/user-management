...
import { registerUserAction } from "../../redux/slice/userSlices/userSlices";
...
const dispatch=useDispatch()
  ...
  const {loading,appErr,serverErr,userAuth,userRegister}=store
 console.log(serverErr,'51');
            ...
            <div className="flex flex-wrap items-center -mx-4">
              <div className="w-full lg:w-2/5 px-4">
                <div className="px-6 lg:px-12 py-12 lg:py-24 bg-white shadow-lg rounded-lg">
                  ...
                  {serverErr} {appErr} -email already exist
                  </div>:null}
                    </h3>
                 ...
                 <a href="/" style={{'color':'blue','text-decoration': 'underline'}}> login </a>
                 </div>
                 {/* } */}
                  </form>
                </div>
